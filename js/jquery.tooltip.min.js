...
(function ($) {
    ...
    function update(event) {
        ...
        if (event) {
			...
			if (  parseFloat(top) > parseFloat(document.getElementById("ecosysRegionInhabitantBottom").style.top))
			       top =  parseFloat(document.getElementById("ecosysRegionInhabitantBottom").style.top);
            helper.parent.css({
                left: left,
                right: right,
                top: top
